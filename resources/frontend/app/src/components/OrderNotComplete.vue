    ...
    <dvi class="main">
        ...
        <div class="container">
            <dialog-component v-model:show="dialogVisible">
                ...
                <button type="button" class="btn btn-primary btn-lg" @click="completeOrder(currentBook.id)"> поддтвердить</button>
            ...
            <div v-if="Object.keys(orders).length > 0">
                ...
                >
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-primary btn-lg" @click="showDialog(order.book)"> вернуть книгу
                        </button>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        getCompletePrice(book) {
            console.log(book)
            OrderDataService.getCompletePrice(book, this.$store.state.token)
                .then(response => {
                    console.log(response.data)
